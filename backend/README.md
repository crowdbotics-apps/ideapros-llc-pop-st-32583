...
## Project Structure
    ...
    ├── ideapros_llc_pop_st_32583  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_pop_st_32583`
...
2. Clone this repo and `cd ideapros_llc_pop_st_32583`
